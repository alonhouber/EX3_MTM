...
typedef struct Lock {
	HANDLE read_lock;//Semaphore To lock reading in case of case other thread is writing
	HANDLE write_lock;//Semaphore To lock writing in case of case other thread is reading
	HANDLE write_lock_mutex;//Prevents writing in case of case other thread is writing
	HANDLE pop_lock_mutex;//Prevents Popping in case other thread is Popping
}Lock;
/*========================================================================*/
